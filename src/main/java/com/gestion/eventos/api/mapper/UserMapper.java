...
public abstract class UserMapper {
    ...
    public abstract List<UserResponseDto> toUserResponseDto(List<User> users);
    ...
    public Set<Role> mapRolesStringsToRoles(Set<String> roleNames) {
        ...
        if (roleNames == null || roleNames.isEmpty()) {
            return roleRepository.findByName("ROLE_USER")
                    ...
                    .orElseThrow(() -> new ResourceNotFoundException("Error: Rol predeterminado no encontrado: ROLE_USER." +
